...
const rawSVG = `<svg class="geo-figure" id="geo-svg" viewBox="0 0 400 580" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="head-glow" cx="50%" cy="40%" r="60%">
      <stop offset="0%" stop-color="oklch(62% 0.22 18)" stop-opacity="0.9"/>
      <stop offset="50%" stop-color="oklch(42% 0.185 18)" stop-opacity="0.85"/>
      <stop offset="100%" stop-color="oklch(22% 0.1 18)" stop-opacity="0.8"/>
    </radialGradient>
    <radialGradient id="torso-grad" cx="40%" cy="30%" r="70%">
      <stop offset="0%" stop-color="oklch(38% 0.16 18)" stop-opacity="0.85"/>
      <stop offset="100%" stop-color="oklch(18% 0.08 18)" stop-opacity="0.9"/>
    </radialGradient>
    <filter id="fig-halo">
  ...
  <polygon class="fig-part" id="fig-head-shadow" points="200,38 278,175 122,175" fill="oklch(18% 0.08 18)" opacity="0.6"/>
  <polygon class="fig-part" id="fig-head-main" points="200,38 278,175 122,175" fill="url(#head-glow)" opacity="0.92"/>
  <polygon points="200,38 239,108 161,108" fill="oklch(72% 0.2 18)" opacity="0.28"/>
  <polygon points="200,38 278,175 239,108" fill="oklch(52% 0.19 18)" opacity="0.4"/>
  <polygon points="200,38 161,108 122,175" fill="oklch(28% 0.12 18)" opacity="0.5"/>
  <polygon points="161,108 239,108 278,175 122,175" fill="oklch(32% 0.14 18)" opacity="0.45"/>
  ...
  <polygon points="200,38 278,175 122,175" fill="none" stroke="oklch(72% 0.22 18)" stroke-width="0.8" opacity="0.5" filter="url(#fig-sharp-glow)"/>

  <rect class="fig-part" id="fig-neck" x="182" y="175" width="36" height="32" fill="oklch(42% 0.17 18)" opacity="0.85"/>
  <rect x="186" y="175" width="12" height="32" fill="oklch(60% 0.2 18)" opacity="0.2"/>

  <polygon class="fig-part" id="fig-shoulders" points="72,207 328,207 362,262 38,262" fill="var(--crimson)" opacity="0.7"/>
  <polygon points="72,207 200,207 200,262 38,262" fill="oklch(52% 0.19 18)" opacity="0.25"/>
  <polygon points="328,207 200,207 200,262 362,262" fill="oklch(28% 0.12 18)" opacity="0.3"/>
  ...
  <rect x="148" y="262" width="40" height="158" fill="oklch(48% 0.18 18)" opacity="0.2"/>
  <line x1="200" y1="262" x2="200" y2="420" stroke="oklch(62% 0.2 18)" stroke-width="0.8" opacity="0.35"/>
  ...
  <polygon class="fig-part" id="fig-arm-l" points="38,262 72,262 48,420 14,420" fill="oklch(32% 0.14 18)" opacity="0.8"/>
  <polygon points="38,262 55,262 31,420 14,420" fill="oklch(42% 0.16 18)" opacity="0.2"/>

  <polygon class="fig-part" id="fig-arm-r" points="328,262 362,262 386,420 352,420" fill="oklch(32% 0.14 18)" opacity="0.8"/>
  <polygon points="345,262 362,262 386,420 369,420" fill="oklch(22% 0.1 18)" opacity="0.3"/>

  <line x1="200" y1="175" x2="200" y2="420" stroke="oklch(62% 0.2 18)" stroke-width="1" opacity="0.4" stroke-dasharray="3 7"/>
  ...
  <line id="fig-shard3" x1="8" y1="220" x2="34" y2="214" stroke="oklch(62% 0.2 18)" stroke-width="2" opacity="0.8"/>
  <line id="fig-shard4" x1="366" y1="220" x2="392" y2="226" stroke="oklch(62% 0.2 18)" stroke-width="2" opacity="0.8"/>
